...
> \*\*Co-Supervisors:\*\* Prof JC Jansen van Vuuren, Dr. Z Dawood 

> \*\*Namespace:\*\* `http://www.semanticweb.org/209332175/ontologies/2024/LFTDO#`
...
│   ├── LFTDO\_v0.04.owl         ← Initial validated OWL file

│   └── ABox/

│       └── Scenario1\_2/        ← Manual Protégé ABox (Scenarios 1 \& 2)

├── v0.05/

│   ├── README.md               ← v0.05 release notes and metrics

│   ├── LFTDO\_v0.05.owl         ← Revised OWL file
...
│   ├── LFTDO\_v0.12.owl         ← Final production OWL file

│   ├── ABox/

│   │   ├── Cellfie/

│   │   │   ├── 1\_Sheep\_SensorData\_LoadData.xls

│   │   │   ├── 1\_SensorData\_MAPPING\_RULE.json

│   │   │   └── \[additional entity file pairs]

│   │   └── Scenarios/

│   │       ├── Scenario1\_Goat\_BehaviouralAnomaly.owl

│   │       ├── Scenario2\_Cow\_ComplexTheft.owl

│   │       ├── Scenario3\_Sheep\_RestingHealthCheck.owl

│   │       ├── Scenario4\_Sabotage\_DeviceTamper.owl

│   │       └── Scenario5\_Sheep100\_HighSpeedFlight.owl

│   ├── SPARQL/

│   │   └── CQ1\_CQ8\_Queries.sparql

│   └── docs/

│       └── LFTDO\_Documentation.html

└── docs/

&#x20;   ├── LFTDO\_Architecture\_Diagram.png

&#x20;   └── LFTDO\_OntoGraf\_Visualisation.png
...
\- \*\*Two-subdomain architecture:\*\* Livestock Management \& Environment (contextual baseline) + Livestock Theft Detection (detection logic)
...
| 1 | Behavioural Anomaly Detection | Goat | RL\_GOAT\_ANOMALY\_TRANSITION, RL\_BEHAVIOUR\_DEVIATION | HighRustlingTheftEvent |

| 2 | Multi-Factor Complex Theft | Cattle | RL\_COMPLEXTHEFT\_CORRELATION, RL\_CATTLEFEVER\_DETECTION | ComplexTheftEvent |

| 3 | Resting Behaviour Health Check | Sheep/Goat/Cattle | RL\_PROLONGED\_RESTING\_DEVIATION\_\* | HealthAlertEvent (not TheftEvent) |

| 4 | Sabotage / Device Tamper Detection | — | RL\_DEVICE\_SABOTAGE\_CHECK, RL\_SYSTEM\_INTEGRITY\_CHECK | SecurityBreachEvent |

| 5 | High-Speed Flight (Cellfie scale, 100 Sheep) | Sheep | RL\_THEFT\_IN\_PROGRESS, RL\_FENCE\_BREACH\_THEFT\_SPEED | HighSpeedTheftEvent |
...
&#x20; \[EntityType]\_MAPPING\_RULE.json   ← Cellfie DSL rules referencing column addresses
...
1\. Open Protégé 5.5.0 with `LFTDO\_v0.12.owl` loaded
...
All eight Competency Questions are implemented as SPARQL queries. See `v0.12/SPARQL/CQ1\_CQ8\_Queries.sparql`.
...
| \*\*v0.12\*\* | \*\*Final — 2,000+ individuals (Cellfie) + full CQ validation\*\* | \*\*100%\*\* | \*\*19,716\*\* |
